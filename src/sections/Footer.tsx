        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 mb-16">
              ...
              {['Services', 'Réalisations', 'Contact'].map((label) => (
                <li key={label}>
                  <a
                    ...
                    className="text-sm uppercase tracking-wide text-white/70 transition-colors duration-300 hover:text-[#e85d26]"
                  >
                    {label}
                  </a>
                </li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a
                href="mailto:contact.devmaroc@gmail.com"
                className="text-sm block text-white/70 transition-colors duration-300 hover:text-[#e85d26]"
              >
                CONTACT.DEVMAROC@GMAIL.COM
              </a>
              <a
                href="tel:+212625869380"
                className="text-sm block text-white/70 transition-colors duration-300 hover:text-[#e85d26]"
              >
                +212 6 25 86 93 80
              </a>
